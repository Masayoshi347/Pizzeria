...
import 'package:pizzaria/ui/pizza_list.dart';
import 'package:pizzaria/ui/share/buy_button_widget.dart';
import 'package:pizzaria/ui/share/pizzeria_style.dart';
import 'package:pizzaria/model/option_item.dart';
import 'package:pizzaria/ui/share/total_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Image.asset(
            'asset/images/pizzas/${widget._pizza.image}',
            height: 180,
          ),
          Text(
              'Recette',
